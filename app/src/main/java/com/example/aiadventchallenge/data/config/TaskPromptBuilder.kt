...
object TaskPromptBuilder {
    ...
    private fun getPhaseInstructions(phase: TaskPhase): String = when (phase) {
        ...
        ЦЕЛЬ: Выполнить работу, создать результат и передать на проверку

        ================================================================
          🚨 ЧТО ЗАПРЕЩЕНО В EXECUTION 🚨
        ================================================================

         СТРОГО ЗАПРЕЩЕНО:
         ❌ Использовать task_completed: true ← Только в VALIDATION!
         ❌ Использовать transition_to: VALIDATION ← Автоматический переход!
         ❌ Завершать задачу без проверки
         ❌ Задавать вопросы о результатах (это для VALIDATION)

         РАЗРЕШЕНО:
         ✅ Создавать детальный результат с конкретными данными
         ✅ Использовать форматы: "4x8", "3x12", "г", "ккал", "мин"
         ✅ Предоставлять полный результат работы

        ================================================================
          📋 КАК ЗАВЕРШИТЬ ФАЗУ EXECUTION 📋
        ================================================================

        Когда работа выполнена и результат готов:
        1. ПРЕДОСТАВЬ полный результат пользователю
        2. ЗАДАЙ вопрос: "Всё устраивает? Нужно ли что-то изменить?"
        3. УСТАНОВИ:
           - step_completed: true ✅
           - next_action: "Результат готов, перехожу к проверке"
           - transition_to: null ← ВАЖНО!
           - task_completed: false ← ВАЖНО!

        Пользователь подтвердит → автоматический переход в VALIDATION

        ПРОТОКОЛ ВЗАИМОДЕЙСТВИЯ В EXECUTION:

        Сценарий 1: Завершение работы
        L: "Вот детальный план питания..."
           **Завтрак:** Овсянка 100г, яйца 2 шт, банан 1шт...
           **Обед:** Гречка 150г, куриная грудка 200г...
           
           Всё устраивает? Нужно ли что-то изменить?
        U: "Да" / "Всё отлично" / "Хорошо"
        → Автоматический переход в VALIDATION

        Сценарий 2: Несогласие (возврат в PLANNING)
        L: "Вот детальный план..."
           Всё устраивает?
        U: "Давай сначала уточним цели" / "Вернемся к планированию"
        L: "Хорошо, возвращаюсь на планирование..."
        → transition_to: PLANNING ✅

        Сценарий 3: Корректировки без возврата
        L: "Вот детальный план..."
           Всё устраивает?
        U: "Добавь ещё один прием пищи" / "Измени что-то"
        L: "Понял, вношу изменения..."
        → step_completed: false
        → Продолжаю в EXECUTION

        ПРИМЕР ПРАВИЛЬНОГО ДИАЛОГА:
        L: Составляю детальный план питания на день:
           
           **Прием пищи 1 (07:00):**
           - Овсянка на воде: 100 г сухой крупы
           - Яичные белки: 4 шт (120 г)
           - Банан: 1 средний (120 г)
           КБЖУ: ~420 ккал / 28 г белка / 8 г жиров / 60 г углеводов
           
           **Прием пищи 2 (10:00):**
           - Творог 5%: 200 г
           - Миндаль: 30 г
           КБЖУ: ~240 ккал / 20 г белка / 12 г жиров / 8 г углеводов
           
           **Прием пищи 3 (13:00):**
           - Гречка: 150 г сухой
           - Куриная грудка: 200 г
           - Овощной салат: 150 г с 1 ст.л. масла
           КБЖУ: ~520 ккал / 45 г белка / 15 г жиров / 55 г углеводов
           
           Общая сумма: ~2685 ккал / 201 г белка / 89 г жиров / 268 г углеводов
           
           Всё устраивает? Нужно ли что-то изменить?
           
           task_intent: CONTINUE_TASK
           step_completed: true ✅
           next_action: "План питания составлен, жду подтверждения"
           transition_to: null ❌

        ПРИМЕР ВОЗВРАТА В PLANNING:
        U: Давай сначала уточним цели
        L: Хорошо, возвращаюсь на планирование...
        ...
        ПРИМЕР КОРРЕКТИРОВКИ БЕЗ ПЕРЕХОДА:
        U: Добавь ещё один прием пищи перед сном
        L: Понял, добавляю прием пищи перед сном...
           
           **Прием пищи 6 (22:00):**
           - Казеиновый протеин: 30 г
           - Или греческий йогурт 0%: 200 г
           КБЖУ: ~120 ккал / 25 г белка / 1 г жиров / 4 г углеводов
           
           Обновлённая сумма: ~2805 ккал / 226 г белка / 90 г жиров / 272 г углеводов
           
           Теперь всё устраивает?
           
           task_intent: CONTINUE_TASK
           step_completed: false ❌
           next_action: "Вношу корректировки в план"
           transition_to: null

        ❌❌❌ ЗАПРЕЩЕННЫЕ ОТВЕТЫ В EXECUTION ❌❌❌:
        → task_completed: true ❌❌❌ (только в VALIDATION!)
        → transition_to: VALIDATION ❌❌❌ (автоматический переход!)
        → Завершение задачи без проверки ❌
        → "Задача выполнена" ❌ (это для VALIDATION)

        ДОПУСТИМЫЕ ПЕРЕХОДЫ: PLANNING (явный возврат)
        (VALIDATION происходит автоматически через step_completed: true)
         """.trimIndent()

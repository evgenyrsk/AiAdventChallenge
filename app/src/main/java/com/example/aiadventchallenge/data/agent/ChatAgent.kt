...
================================================================================
 ...
 - schedule_reminder: запланировать напоминание (через X минут или на конкретное время)
 - get_pending_reminders: показать все запланированные напоминания
 - cancel_task: отменить запланированную задачу
 - run_task_now: выполнить задачу прямо сейчас

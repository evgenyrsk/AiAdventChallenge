...
object FitnessRagConfig {
    ...
    const val DEFAULT_MIN_ANSWERABLE_CHUNKS = 1
    const val ENHANCED_MIN_ANSWERABLE_CHUNKS = 2
    ...
    val basicPipeline: RagPipelineConfig
        get() = RagPipelineConfig(
            ...
            minAnswerableChunks = DEFAULT_MIN_ANSWERABLE_CHUNKS,
    ...
    val enhancedPipeline: RagPipelineConfig
        get() = RagPipelineConfig(
            ...
            minAnswerableChunks = ENHANCED_MIN_ANSWERABLE_CHUNKS,
